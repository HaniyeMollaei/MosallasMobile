...
import 'get_guild_id.dart';

class GetNationalCodePage extends StatefulWidget{
  const GetNationalCodePage({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => GetNationalCodePageState();

}

class GetNationalCodePageState extends State<GetNationalCodePage>{

  final TextEditingController _txtNationalCode = TextEditingController(text: '');
  final FocusNode _fndNationalCode = FocusNode();
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          ///national code 0.08
                          MyTextField(
                            controller: _txtNationalCode,
                            focusNode: _fndNationalCode,
                          ...
                          SubmitButton(text: "ادامه",
                            onPressed: () async {
                              await Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => const GetGuildIdPage()));
                              },
                            isDisable: false,
                          ),
                        ],
